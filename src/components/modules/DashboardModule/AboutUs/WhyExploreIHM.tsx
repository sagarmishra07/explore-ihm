...
import {WhyExploreIHMDTO} from "@/utils/formatters/WhyExploreIHMDTO";

const firebaseUrl = 'AboutUs/WhyExploreIHM';
...
function WhyIHM() {
    ...
    const getAllData = async () => {
        ...
        const afterFormat = WhyExploreIHMDTO.receive(res);
    ...
    const onSubmit = async (values: any) => {
        try {
            setLoading(true);
            const formatted: any = WhyExploreIHMDTO.create(values);
...
WhyIHM.Layout = AdminDashboardLayout;
export default WhyIHM