...
import {MessageFromMDDTO} from "@/utils/formatters/MessageFromMDDTO";
import ImageUpload from "@/components/common/ImageUpload";

const firebaseUrl = 'AboutUs/MessageFromPD';
const RichTextEditor = dynamic(import('@mantine/rte'), {
    ssr: false,
    loading: () => null,
});

function MessageFromPD() {
    ...
    const getAllData = async () => {
        ...
        const afterFormat = MessageFromMDDTO.receive(res);
        setValue("description", afterFormat?.description)
        setValue("imageUrl", afterFormat?.imageUrl)
    ...
    const onSubmit = async (values: any) => {
        try {
            setLoading(true);
            const formatted: any = MessageFromMDDTO.create(values);
...
MessageFromPD.Layout = AdminDashboardLayout;
export default MessageFromPD